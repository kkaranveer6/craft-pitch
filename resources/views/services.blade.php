      ...
      <div class="row row-30">
        <div class="col-sm-6 col-lg-4">
          <div class="box-icon-classic">
            ...
            <h4 class="box-icon-title"><a href="single-service.html">Web Design</a></h4>
            <p>
              It is most vital to search out right web site style for your business. 
              internet style may be a extremely revered technique for participating the web audience. 
              a good internet style can emphasise the practicality of the location, likewise as its inventive worth. 
              CRAFTPITCH styles websites that ar distinctive, exceptional, user friendly, informative, enticing and delightful. 
              we have a tendency to style websites for our customers who want a skilled presence of their business on web.
            </p>
            <a class="button-link" href="single-service.html">
              <span>read more</span><span class="icon fa-long-arrow-right"></span>
            </a>
          </div>
        </div>
        <div class="col-sm-6 col-lg-4">
          <div class="box-icon-classic">
            ...
            <h4 class="box-icon-title"><a href="single-service.html">Web developer</a></h4>
            <p>
              Anything you can imagine on the web can be created by a skilled web developer. 
              a developer is responsible for developing server-side aspects applications, databases, complicated e-commerce transactions, and search engine optimisation. 
              We use the following web Development technologies - HTML/XHTML, CSS, PHP, ASP, ASP.Net, MySQL, Flash, Java, Java Script/AJAX/JQUERY.
            </p>
            <a class="button-link" href="single-service.html">
              <span>read more</span><span class="icon fa-long-arrow-right"></span>
            </a>
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="box-icon-classic">
            ...
            <h4 class="box-icon-title"><a href="single-service.html">Web Maintenance</a></h4>
            <p>
              In the world of contantly advancement and technology it's vital to stay your website up to date to keep users visiting your sites. 
              thus website maintenance is incredibly vital. 
              we design websites so you'll be able to update content at any time or are able to at low rates. 
              Following ar some things that we are able to do to take care of your websites, 
                Text improvement, 
                Update information, 
                Adding or changing photos, 
                Update pages, Articles, Announcements, 
                Product changes, Add breaking news and new events
            </p>
            <a class="button-link" href="single-service.html">
              <span>read more</span><span class="icon fa-long-arrow-right"></span>
            </a>
